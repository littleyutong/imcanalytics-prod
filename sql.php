...
<?php
$sql = "select customer.LastCart bookdetails.title from Customer inner join bookdetails on customer.LastCart =  bookdetails.bid";
...
//An array is a special variable, which can hold more than one value at a time and allow us to access the values by referring to an index number. 
